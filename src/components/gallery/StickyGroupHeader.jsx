  ...
  return (
    <>
      ...
      <div
        ref={stickyRef}
        data-stuck={stuck}
        className={`group/sticky sticky top-48 md:top-[var(--nav-h)] z-30 bg-sticky-bg -mx-12 px-12 py-3 border-b-2 border-transparent transition-all duration-200 data-[stuck=true]:py-5 data-[stuck=true]:border-white ${className}`}
      >
